...
### **Synopsys VCS**
    ...
    vcs -sverilog design.sv verification.sv
    ./simv

### **Cadence Xcelium**

    xrun design.sv verification.sv
...
-   Add scoreboard for data integrity checking\
-   Additional assertion layers\
-   Multi-slave support\
-   Error-injection tests\
-   Migration to full UVM environment
